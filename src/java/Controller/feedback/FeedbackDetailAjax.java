 ...
 * @author user
 */
@WebServlet(name = "FeedbackDetailAjax", urlPatterns = {"/feedbackDetailmkt"})
public class FeedbackDetailAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Feedback fb = new FeedbackDAO().getFeedbackByID(ID);
