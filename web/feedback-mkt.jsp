                            ...
                            <tbody id="tbody">
                                <c:forEach items="${feedbackList}" var="feedback">
                                    <tr>
                                        ...
                                        <td id="statuss-${feedback.getId()}">
                                            <c:if test="${feedback.getStatus()== 1}"><div style="color: green;">Done</div></c:if>
                                            <c:if test="${feedback.getStatus()== 0}"><div style="color: red;">In Progress</div></c:if>
                                        </td>
                                        <td>
                                            <button onclick="getDetail('${feedback.getId()}')" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" >View</button>
                                        </td>
                                    </tr>
                                </c:forEach>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div id="modal-body" class="modal-body">
        ...
        <div>Comment: </div>
        <div>Status: </div>
        <div><button onclick="setDone()">set Done</button></div>
      </div>
