...
<html>
    ...
    <body>
        ...
        <form action="register" method="post" enctype="multipart/form-data" style="border:1px solid #ccc">
            <div class="container">
                <h1>Sign Up</h1>
                ...
                <c:if test="${pass != repass}">
                    <p style="color: red;">Repeat password not matched </p>
                </c:if>
